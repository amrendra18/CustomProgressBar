...
public class CustomProgressBar extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        outerRing.set(actualPadding, actualPadding, w - actualPadding, h - actualPadding);
        innerRing.set(actualPadding + outerRing.width() / 2 * (1.0f - ringRadiusRatio),
                actualPadding + outerRing.height() / 2 * (1.0f - ringRadiusRatio), w
                        - actualPadding - outerRing.width() / 2 * (1.0f - ringRadiusRatio), h
